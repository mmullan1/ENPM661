...
**In one terminal:**
```
cd ~/Documents/GitHub/ENPM661/Project3/Phase2/Phase2/Gazebo/project3_ws
```
...
```
cd ~/Documents/GitHub/ENPM661/Project3/Phase2/Phase2/Gazebo/project3_ws/src/turtlebot3_proj3_661/scripts
```
...
This file is generated by `a_star_michael.py` and contains the trajectory commands sent to the robot.

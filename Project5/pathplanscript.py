...
def build_collision_map(clearance):
    """
    Rebuild your obstacle course inside astar_planner.py so Falcon can call it
...
def plan_path(start,
              ...
              logger):
    """
    Falcon-compatible wrapper around your planner.
    ...
    # Falcon passes heading in radians; mine planner uses degrees
    # 
    ...
    # Your old script used total clearance = obstacle clearance + robot radius
